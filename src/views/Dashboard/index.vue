<template>
  <nav>
    ...
    <div class="nav-wrapper">
      <ul>
        <li>
          <router-link to="/dashboard" active-class="active" class="large_devices">Wallet</router-link>
        </li>
        <li>
          <router-link to="/dashboard/profile" active-class="active" class="large_devices">Profile</router-link>
        </li>
        <li class="large_devices" @click="switchLargeNav">{{fullName}}</li>
        <li
          class="small_devices"
          @click="switchSmallNav"
          :class="smallNav? 'nav_on':''"
        >{{fullName | initials}}</li>
      </ul>
  ...
  <transition name="dash">
    ...
    >
      <ul>
        <li>{{fullName}}</li>
        <li>
          <router-link to="/dashboard" active-class="small_active" exact>Portfolio</router-link>
        </li>
        <li>
          <router-link to="/dashboard/wallets" active-class="small_active">Wallet</router-link>
        </li>
        <li>
          <router-link to="/dashboard/profile" active-class="small_active">Profile</router-link>
        </li>
